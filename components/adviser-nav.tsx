...
import { Calendar, Clipboard, ClipboardCheck, HamburgerIcon, Home, LogOutIcon, MenuIcon, PlusIcon, SearchIcon } from 'lucide-react'
  ...
  <NavigationMenuList>
    <NavigationMenuItem>
      ...
      <NavigationMenuContent className='w-36 flex-col items-center'>
       ...
       <NavigationMenuLink href='/dashboard/schedules' >
       Schedules
      </NavigationMenuLink>
        </div>
         <div className='flex items-center'>
